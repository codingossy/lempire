     ...
     <div className='relative'> 
           ...
           <div className=''>
             {CardData.map(( {data1, data2, img3, button, desc, img }) => {
               return (
                 <div>
                    <img src={data1} alt="" className='hidden lg:block absolute top-1/4 -translate-y-2/4 w-52'/>
                    <img src={ data2 } alt="" className='hidden lg:block absolute top-1/4 -translate-y-1/2 -right-24 w-52'/>

                          {/* body */}
                    <div className='details bg-gradient-to-r from-gray-500 to-gray-900 px-12 pt-48 rounded-2xl mb-20' data-aos='fade-up' data-aos-delay="800">
