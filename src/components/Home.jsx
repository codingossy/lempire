    ...
    <section className='w-full'>
           {/* backgrounds */}
            <div className='w-full h-full flex items-center justify-center'>
                <img src={home} alt="" className='w-[30rem] absolute' data-aos='zoom-in' data-aos-delay="100"/>
                  <img src={home2} alt="" className='w-[30rem]' data-aos='zoom-in' data-aos-delay="500"/>
            </div>
       ...
       <div className='flex flex-col md:items-center md:justify-start'>
              <div className=''>
              <img src={elena} alt="" className='w-32' data-aos='fade-down' data-aos-delay="300"/>
              </div>


             <div className=''>
             <img src={arrow} alt="" className='w-8' data-aos='fade-up' data-aos-delay="300"/>
             </div>
            ...
            <div className='text-center sm:bg-black sm:rounded-md sm:p-6 md:bg-inherit flex flex-col items-center justify-center'>
                <h1 className='text-purple-800 sm:text-5xl md:text-6xl text-center font-bold z-10' data-aos='zoom-in' data-aos-delay="400">we <span className='text-white' >build the future <br /> of relationships </span></h1>
             ...
             <div className='btn py-6' data-aos='fade-up' data-aos-delay="500">
